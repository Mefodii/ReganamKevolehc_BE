...
CONTENT_ITEM_PART_STATUS_NONE = "NONE"
CONTENT_ITEM_PART_STATUS_CHECKED = "CHECKED"
...
CONTENT_ITEM_PART_STATUS_CHOICES = (
    (CONTENT_ITEM_PART_STATUS_NONE, CONTENT_ITEM_PART_STATUS_NONE),
    (CONTENT_ITEM_PART_STATUS_CHECKED, CONTENT_ITEM_PART_STATUS_CHECKED),
