    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_at', models.DateTimeField(blank=True, default=datetime.datetime(2001, 1, 1, 0, 0, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Waiting', 'Waiting'), ('Running', 'Running'), ('Finished', 'Finished'), ('Warning', 'Warning'), ('Error', 'Error'), ('Dead', 'Dead'), ('None', 'None')], max_length=50)),
                ...
                ('file_extension', models.CharField(blank=True, choices=[('mkv', 'mkv'), ('mp4', 'mp4'), ('mp3', 'mp3'), ('m4a', 'm4a')], max_length=50, null=True)),
